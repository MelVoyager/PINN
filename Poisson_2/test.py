...
from Function.Poisson_Boltzmann_2d import u, f
os.chdir(sys.path[0])
...
# train the model
vpinn = VPINN([2, 20, 20, 20, 1], f, u, type=0, Q=10, grid_num=8, boundary_num=80, test_fcn_num=5, device='cpu', load=None)
net = vpinn.train("Poisson_Boltzmann_2d", epoch_num=10000, coef=10)
