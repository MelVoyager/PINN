...
# train the model
device = 'cpu'
vpinn = VPINN([2, 10, 10, 10, 1],pde, bc(80), area=[-1, -1, 1, 1], Q=10, grid_num=16, test_fcn_num=5, 
            device=device, load=None)


net = vpinn.train("Poisson_Boltzmann_0", epoch_num=10000, coef=10 ** (3 - np.log2(vpinn.grid_num)))
